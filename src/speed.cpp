#include "speed.h"
#include "main.h"
Speed::Speed(float x, float y,float z, float rotation, color_t color,color_t color1, color_t color2) 
{
    ...
    this->object1 = create3DObject(GL_TRIANGLES, 6, vertex_buffer_data1, color1, GL_FILL);
