#include "circ.h"
#include "main.h"
Circ::Circ(float x, float y,float z, float rotation, color_t color,color_t color1, color_t color2) 
{
...
void Circ::set_position(float x, float y,float z) {
    this->position = glm::vec3(x, y, z);
}
