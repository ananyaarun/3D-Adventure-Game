...
#include "main.h"
using namespace std;
Gun::Gun(float x, float y,float z, float r, color_t color) 
{
...
void Gun::set_position(float x, float y,float z) {
    this->position = glm::vec3(x, y, z);
}
