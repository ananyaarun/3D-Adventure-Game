...
Chk::Chk(float x, float y,float z, float r, color_t color) 
{
...
void Chk::set_position(float x, float y,float z) {
    this->position = glm::vec3(x, y, z);
}
